...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    ArrayList<String> ignored = new ArrayList<>(Arrays.asList("/api/v1/users/signup", "/h2-console", "/favicon.ico", "/api/v1/users/login"));
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (ignored.stream().noneMatch(str -> request.getRequestURI().startsWith(str))) {
